...
def init_database():
    ...
    if userName in database:
        ...
        database[userName] = { 'logins' : {'attempts' : 1},
                               'digit0attempted': 0,
                               'digit1attempted': 0,
                               'digit2attempted': 4, #digit two will be picked
                               'digit3attempted': 4,
                               'digit4attempted': 4,
                               'digit5attempted': 4,
                               'digit6attempted': 4,
...
def input_correct_database_sign(userName, signTryed):
    database = pickle.load(open('userData/database.p', 'rb'))
    database[userName]['correctAttempts'][signTryed] += 1
    pickle.dump(database,open('userData/database.p','wb'))
